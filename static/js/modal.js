 var modal = (function() {                         // Declare modal object
  ...
  var $close = $('<button role="button" class="modal-close">&times;</button>');
  ...
  return {                                        // Add code to modal
    center: function() {                          // Define center() method
      ...
      $content.css({                                // Set CSS for the modal
